...
namespace VAT.Packaging.Editor {
    public static class PackageTools {
        [MenuItem("VAT/Cryst SDK/Tools/Import Package")]
        public static void ImportPackage() {
            ...
            if (!string.IsNullOrWhiteSpace(path)) {
                ...
                AssetDatabase.CreateAsset(package, $"{addressPath}/{package.Title}.asset");
                ...
                foreach (var content in initialContents) {
                    AssetDatabase.CreateAsset(content, $"{addressPath}/_{content.Title}.asset");
